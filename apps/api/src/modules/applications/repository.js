...
function parseReviewerMetadata(rawValue) {
  ...
  if (typeof rawValue === "object") {
      return {
        ...
        applicantPhone: rawValue.applicantPhone || rawValue.phoneNumber || null,
  ...
  try {
    ...
    if (parsed && typeof parsed === "object" && !Array.isArray(parsed)) {
      return {
          ...
          applicantPhone: parsed.applicantPhone || parsed.phoneNumber || null,
...
function serializeReviewerMetadata(value) {
  ...
  return JSON.stringify({
      ...
      applicantPhone: value.applicantPhone || value.phoneNumber || null,
...
function mapApplicationRecord(application) {
  ...
  const record = {
    ...
    phoneNumber: student?.phoneNumber || reviewerMeta.applicantPhone || null,
    applicantPhone: reviewerMeta.applicantPhone || null,
...
function mapApplicationRow(row) {
  ...
  const record = {
    ...
    phoneNumber: row.phone_number || reviewerMeta.applicantPhone || null,
    applicantPhone: reviewerMeta.applicantPhone || null,
